 ...
 * 
 * This script populates Foru.ms with demo school data including:
 * - Demo school
 * - Subjects (Physics, Math, CS, Chemistry)
 * - Courses for each subject
 * - Chapters for each course
 * - Contributions for chapters
 * - AI-generated notes
 * 
...
async function forumApiCall(endpoint: string, method: string = 'GET', data?: any) {
...
const demoData = {
  ...
  chapters: {
    'PHY-101': [
      ...
      { label: 'Lec 04', title: 'Work & Energy', date: 'Sep 15', status: 'AI Ready' },
      { label: 'Lec 05', title: 'Momentum & Collisions', date: 'Sep 19', status: 'Collecting' },
      { label: 'Lec 06', title: 'Rotational Motion', date: 'Sep 22', status: 'Collecting' },
    ],
    'PHY-102': [
      { label: 'Lec 01', title: 'Wave Properties', date: 'Sep 6', status: 'Compiled' },
      { label: 'Lec 02', title: 'Sound Waves', date: 'Sep 9', status: 'Compiled' },
      { label: 'Lec 03', title: 'Light & Reflection', date: 'Sep 13', status: 'AI Ready' },
      { label: 'Lec 04', title: 'Refraction & Lenses', date: 'Sep 16', status: 'Collecting' },
    ],
    'PHY-201': [
      { label: 'Lec 01', title: 'Electric Fields', date: 'Sep 7', status: 'Compiled' },
      { label: 'Lec 02', title: 'Gauss Law', date: 'Sep 10', status: 'AI Ready' },
      { label: 'Lec 03', title: 'Electric Potential', date: 'Sep 14', status: 'Collecting' },
    ],
    'MATH-201': [
      ...
      { label: 'Lec 03', title: 'Parametric Equations', date: 'Sep 12', status: 'AI Ready' },
      { label: 'Lec 04', title: 'Polar Coordinates', date: 'Sep 15', status: 'Collecting' },
    ],
    'MATH-301': [
      { label: 'Lec 01', title: 'Vector Spaces', date: 'Sep 6', status: 'Compiled' },
      { label: 'Lec 02', title: 'Linear Transformations', date: 'Sep 9', status: 'AI Ready' },
      { label: 'Lec 03', title: 'Eigenvalues', date: 'Sep 13', status: 'Collecting' },
    ],
    'CSE-110': [
      ...
      { label: 'Lec 03', title: 'Control Flow', date: 'Sep 12', status: 'AI Ready' },
      { label: 'Lec 04', title: 'Functions', date: 'Sep 15', status: 'Collecting' },
    ],
    'CSE-220': [
      { label: 'Lec 01', title: 'Arrays & Lists', date: 'Sep 6', status: 'Compiled' },
      { label: 'Lec 02', title: 'Stacks & Queues', date: 'Sep 9', status: 'AI Ready' },
      { label: 'Lec 03', title: 'Linked Lists', date: 'Sep 13', status: 'Collecting' },
    ],
    'CHEM-121': [
      { label: 'Lec 01', title: 'Hydrocarbons', date: 'Sep 5', status: 'Compiled' },
      { label: 'Lec 02', title: 'Functional Groups', date: 'Sep 8', status: 'Compiled' },
      { label: 'Lec 03', title: 'Isomerism', date: 'Sep 12', status: 'AI Ready' },
      { label: 'Lec 04', title: 'Reaction Mechanisms', date: 'Sep 15', status: 'Collecting' },
    ],
    'CHEM-221': [
      { label: 'Lec 01', title: 'Thermodynamics Basics', date: 'Sep 6', status: 'Compiled' },
      { label: 'Lec 02', title: 'Chemical Kinetics', date: 'Sep 9', status: 'AI Ready' },
      { label: 'Lec 03', title: 'Quantum Chemistry', date: 'Sep 13', status: 'Collecting' },
    ],
  },
  sampleContributions: [
    {
    ...
    },
    {
      ...
      content: 'Here\'s how to solve a typical problem from this chapter:\n\nStep 1: Identify the given information\nStep 2: Apply the relevant formula\nStep 3: Calculate the result',
      anonymous: false,
      authorName: 'Demo Student',
    },
  ],
